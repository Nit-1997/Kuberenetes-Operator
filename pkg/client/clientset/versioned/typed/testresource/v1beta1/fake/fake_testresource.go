...
func (c *FakeTestResources) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.TestResourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTestResources) Create(ctx context.Context, testResource *v1beta1.TestResource, opts v1.CreateOptions) (result *v1beta1.TestResource, err error) {
	obj, err := c.Fake.
...
func (c *FakeTestResources) Update(ctx context.Context, testResource *v1beta1.TestResource, opts v1.UpdateOptions) (result *v1beta1.TestResource, err error) {
	obj, err := c.Fake.
...
func (c *FakeTestResources) UpdateStatus(ctx context.Context, testResource *v1beta1.TestResource, opts v1.UpdateOptions) (*v1beta1.TestResource, error) {
	obj, err := c.Fake.
...
func (c *FakeTestResources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.TestResource, err error) {
	obj, err := c.Fake.
